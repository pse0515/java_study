...
public class CollectionMain {
    public static void main(String[] args) {
        ...
        // 값을 수정 (수정할 인덱스 필수필요, 그다음엔 수정할 값 필요)
...
//        }
        ...
        // 값 추가 / 중복이 안되기 때문에 동일한 값을 넣으면 수정이 된다
        strMap.put("a", "김준일");
        strMap.put("b", "김준이");
        strMap.put("c", "김준삼");
        strMap.put("d", "김준사");
        ...
        //값 삭제
        // 삭제를 할 때 value 값을 가져오는데 중복으로 삭제를 하면 null을 가져온다
        // 삭제를 할 때 key값은 일치하지만 value값이 일치하지 않으면 false를 도출하며 삭제되지 않는다.
